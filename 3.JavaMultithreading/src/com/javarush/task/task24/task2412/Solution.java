    ...
    public static void sort(List<Stock> list) {
       list.sort(new Comparator<Stock>() {
           ...
           public int compare(Stock stock1, Stock stock2) {
               ...
               return stock2Date.compareTo(stock1Date);
           }
       }.thenComparing(new Comparator<Stock>() {
           @Override
           public int compare(Stock stock1, Stock stock2) {
               double stock1Change = stock1.containsKey("change") ? (double) stock1.get("change") : 0d;
               double stock2Change = stock2.containsKey("change") ? (double) stock2.get("change") : 0d;
               return (int) (stock1Change - stock2Change);
           }
       })));
    }
